...
trans_dict = {
    ...
    "enjimg":["好好欣賞現有的植物圖片吧!","Enjoy the beauty of the uploaded plant images!","アップロードされた植物の画像の美しさをお楽しみくださいね！"],
    "clvimgin":["點選上方的「查看更多資訊」吧!","Click on 'View More Info' above!","上の「詳細を見る」をクリックしてね！"],
