...
body = {
    ...
    'areas':[                                   # 選單內容
        ...
        },
        {
            ...
            'action': {'type': 'uri', 'uri': 'https://www.google.com.tw/?gws_rd=ssl' }
        },
        {
        ...
        },
        {
            ...
            'action':{'type': 'uri', 'uri': 'https://www.google.com.tw/?hl=zh_TW'} 
        },
        {
            'bounds': {'x': 0, 'y': 941, 'width':1250, 'height': 740}, # 外來種植物辨識按鈕座標及大小
            'action':{'type': 'postback', 'data': trans_dict["idplant"][0]}
        },
        {
...
body = {
    ...
    'areas':[                                  # 選單內容
        ...
        {
            'bounds': {'x': 0, 'y': 941, 'width':1250, 'height': 740}, # 外來種植物辨識按鈕座標及大小
            'action':{'type': 'postback', 'data': trans_dict["idplant"][1]}
        },
        {
            'bounds': {'x': 1251, 'y': 941, 'width':1250, 'height': 740}, # 歷史紀錄查詢按鈕座標及大小
            'action': {'type': 'postback', 'data': '{"action": "search", "skip": 0}'} 
...
body = {
    ...
    'areas':[                                  # 選單內容
        ...
        {
            'bounds': {'x': 0, 'y': 941, 'width':1250, 'height': 740}, # 外來種植物辨識按鈕座標及大小
            'action':{'type': 'postback', 'data': trans_dict["idplant"][2]}
        },
        {
            'bounds': {'x': 1251, 'y': 941, 'width':1250, 'height': 740}, # 歷史紀錄查詢按鈕座標及大小
            'action': {'type': 'postback', 'data': '{"action": "search", "skip": 0}'} 
...
# 預設圖片為圖文選單
# url= "https://api.line.me/v2/bot/user/all/richmenu/richmenu-5604bcd5ea37fc246788bf7186f0c2a2"
